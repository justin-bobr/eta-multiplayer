...
| `PropertyName.Scale` | Cached name for the 'Scale' field. |
...
| `BearingToBombSpot(BombSpot.BombSlot)` | Compass bearing (0..360°, north = -Z) from the player to the slot's BombSpot; NaN when the map has none. |
