...
public partial class HudCs2 : Node
{
	...
	/// <summary>Writes the name of the <see cref="Zone"/> under the player (via <see cref="Level.ZoneAt"/>) into the zone label.</summary>
	...
	/// <summary>Compass bearing (0..360°, north = -Z) from the player to the slot's BombSpot; NaN when the map has none.</summary>
	...
	/// <summary>Applies the <see cref="Settings"/> HUD edge margins to corner-anchored elements; cached, no-op when unchanged.</summary>
