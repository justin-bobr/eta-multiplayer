...
/// <summary>
/// Minimal floating compass strip without a background box. The HUD feeds it each frame via
/// <see cref="HeadingDegrees"/>: tick marks every 5 degrees, numeric labels every 15 degrees,
/// cardinal labels every 45 degrees, and a red center marker.
/// </summary>
public partial class HudCompass : Control
{
	/// <summary>Current heading in degrees (0..360); set by the HUD each frame.</summary>
	public float HeadingDegrees;
	/// <summary>Compass bearing to bombsite A; NaN hides the marker.</summary>
	...
	/// <summary>Renders ticks, numeric labels, the center marker, and any active objective markers.</summary>
	...
	/// <summary>
	/// Draws a bombsite marker at its compass bearing. If the target is outside the visible
	/// range, the marker sticks to the edge and an arrow points toward the rotation direction.
	/// </summary>
	...
	/// <summary>Draws centered text with a shadow; floating, with no box background.</summary>
