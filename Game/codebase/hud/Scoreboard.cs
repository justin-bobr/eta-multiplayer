...
/// <see cref="NetClient.LastRemoteSnapshots"/>. Action <c>scoreboard</c> (default Tab), refreshed at 4 Hz.
/// </summary>
public partial class Scoreboard : CanvasLayer
{
	...
	/// <summary>Per-team UI cluster: badge (score + name + alive) plus a pooled stack of player rows.</summary>
	...
	/// <summary>Opens the board on the scoreboard-action press; input still fires while _Process is off.</summary>
