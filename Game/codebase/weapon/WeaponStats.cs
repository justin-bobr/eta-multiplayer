...
public record WeaponStats
{
	...
	/// <summary>Server-authoritative damage per <see cref="HitboxGroup"/>; look up via <see cref="DamageFor"/>.</summary>
	...
	/// <summary>Base hip-fire move-speed multiplier on top of Walk/Sprint speed; stacks with <see cref="AdsSpeedMul"/> when aiming.</summary>
	public float MoveSpeedMul { get; init; } = 1.0f;
	/// <summary>Move-speed multiplier while sprinting (separate sprint penalty from <see cref="MoveSpeedMul"/>).</summary>
