...
/// <summary>
/// Debug-Visualization: roter transparenter Body-Capsule auf der vom Server gemeldeten LOCAL-PLAYER
/// Position (= <see cref="NetClient.LastSelfSnap"/>.Pos + .CrouchBlend). Mirror zu
/// <see cref="PuppetPlayer"/>'s sv_pos_debug_capsule der für Remote-Spieler den Server-State zeigt
/// — dieser Node macht das Gleiche für den lokalen Spieler. Wichtig zum visualisieren wann das
