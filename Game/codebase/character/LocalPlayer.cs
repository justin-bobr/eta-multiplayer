...
public partial class LocalPlayer : NetworkPlayer
{
	...
	/// <summary>Re-simulates one tick with the saved input; physics state is re-derived from current position.
	/// Audio, FX and net-send are skipped via <see cref="_isReplaying"/>.</summary>
