...
/// <summary>
/// Owned by <see cref="NetMain"/> in any client mode (Listen + Client). For each remote NetId it
/// instantiates a <see cref="PuppetPlayer"/> driver that renders the player's TPS visuals, feeds it
/// with snapshot state, and removes it on PlayerLeft.
/// </summary>
