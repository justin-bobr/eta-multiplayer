...
public class NetCli
{
	/// <summary>Defaults to <see cref="NetMode.Client"/> so a flagless launch (incl. editor F5) lands in the main menu.</summary>
	...
	/// <summary>Bots the server auto-spawns (capped to free spawn markers), via <c>--bots N</c>. Default 0.
	/// Replaced by real players (lowest-NetId bot despawns).</summary>
