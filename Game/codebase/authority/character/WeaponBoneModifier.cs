...
public partial class WeaponBoneModifier : SkeletonModifier3D
{
	...
	{
		Instance = this;   // editor too, so AnimatedCharacter's ADS test mode can preview the weapon offset
	}
	...
	public override void _ProcessModificationWithDelta(double delta)
	{
		...
		// Runs in the editor too so AnimatedCharacter's ADS test mode can preview the aimed pose live.
