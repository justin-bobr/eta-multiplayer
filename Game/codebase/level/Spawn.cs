...
///
/// <see cref="SpawnManager"/> resolves spawns by Kind via <see cref="Level.SpawnsForKind"/> at
...
public partial class Spawn : Zone
{
	...
	/// pool the spawn goes into (Deathmatch / Team1 / Team2). <see cref="Level.SpawnsForKind"/>
