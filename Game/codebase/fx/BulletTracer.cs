...
/// <summary>
/// Bullet tracer: a short cylindrical streak that travels at bullet speed from the muzzle toward
/// the impact, rather than a static beam from origin to end. The streak has fixed length
/// (<see cref="_streakLength"/>) and translates each frame — reads as a glowing trail instead of
/// a laser beam. Spawn with <see cref="Spawn"/>; auto-frees once the front passes the endpoint.
/// </summary>
public partial class BulletTracer : Node3D
{
	...
	/// <summary>Creates a tracer under the scene root, initializes it and returns the instance.</summary>
	...
	/// <summary>Builds the cylinder mesh/material and places the streak just behind the origin.</summary>
	...
	/// <summary>Advances the streak each frame and frees the node once its front has passed the endpoint.</summary>
