...
/// dead slots are reused via swap-and-pop. Assign to LocalAnimation's Shell Pool export.
/// </summary>
public partial class ShellPool : Node3D
{
	...
	/// <summary>Collider RIDs excluded from the floor raycast (player bodies). Populate via <see cref="AddExcludedBody"/>.</summary>
