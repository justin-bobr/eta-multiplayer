...
/// <see cref="Node3D.TopLevel"/> = true so points are written in world coordinates.
/// </summary>
public partial class GrenadeAimGuide : Node3D
{
	...
	/// <summary>Builds line and ring lazily, robust to whichever of _Ready/<see cref="UpdatePath"/>/<see cref="SetGuideVisible"/> runs first.</summary>
