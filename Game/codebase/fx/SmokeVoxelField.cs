...
/// then bakes the density grid into a 3D texture rendered via a FogVolume.
/// Fully deterministic (fixed timestep/wind, no randomness), so every client gets the same field.
/// </summary>
...
";
	...
	/// <summary>Builds the static shape mask once: a grounded, noise-distorted ellipsoid multiplied into the density in <see cref="Bake"/>.</summary>
