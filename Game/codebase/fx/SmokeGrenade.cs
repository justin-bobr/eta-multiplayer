...
public partial class SmokeGrenade : Node3D
{
	...
	/// <summary>Creates a grenade. Replication is optional via <paramref name="ownerNetId"/>/<paramref name="projectileId"/>; puppet mode follows owner ProjectileState.</summary>
